...
if (
  window.location.pathname == "/senate_loyalty.html" ||
  window.location.pathname == "/senate_attendence.html" ||
  window.location.pathname == "/senate.html"
) {
  // loyal_n_attendence IF
  link = "https://api.propublica.org/congress/v1/113/senate/members.json";
} else if (
  window.location.pathname == "/house_loyalty.html" ||
  window.location.pathname == "/house_attendance.html" ||
  window.location.pathname == "/house.html"
) {
...
function count(obj) {
  ...
  stats["Democrats average votes with their party"] =
    stats["sumDemVotes"] / stats["democrats"].length;
  stats["Republicans average votes with their party"] =
    stats["sumRepVotes"] / stats["republicans"].length;
  stats["totalAvg"] =
    (stats["sumDemVotes"] + stats["sumIndVotes"] + stats["sumRepVotes"]) /
    members.length;
  stats["Independents average votes with their party"] =
    stats["sumIndVotes"] / stats["independents"].length;
  stats["total_members"] =
...
function glance_tab() {
  ...
  r2.innerHTML =
    stats["Republicans average votes with their party"].toFixed(2) + "%";
  d1.innerHTML = stats["democrats"].length;
  d2.innerHTML =
    stats["Democrats average votes with their party"].toFixed(2) + "%";
